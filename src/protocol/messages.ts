...
export type RefreshTokenPoolGroupUsageRequest = {
  type: "REFRESH_TOKEN_POOL_GROUP_USAGE";
  payload: { codexHome?: string; category: TokenPoolRefreshCategory };
};
...
export type RequestMessage =
  ...
  | RefreshTokenPoolGroupUsageRequest
